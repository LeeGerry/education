...
<div class="row w3-center">
			...
			<button class="btn btn btn-default consonant" onclick="copyText(value);setkeyLen(value);setFlags('consonant');disableKeys();"
					...
					<br>
					<button class="btn btn btn-default vowel" onclick="copyText(value);setkeyLen(value);setFlags('vowel');disableKeys();"
					...
					<br>
					<button class="btn btn btn-default stress" onclick="copyText(value);setkeyLen(value);setFlags('stress');disableKeys();"
						value="ˈ" style="width: 40px; height: 40px;">ˈ</button>
					<button class="btn btn btn-default stress" onclick="copyText(value);setkeyLen(value);setFlags('stress');disableKeys();"
						value="ˌ" style="width: 40px; height: 40px;">ˌ</button>
					<button class="btn btn btn-default diacrit" onclick="copyText(value);setkeyLen(value);setFlags('diacrit');disableKeys();"
					...
					<button class="btn btn btn-default" onclick="clean();setFlags('clear');disableKeys();"
